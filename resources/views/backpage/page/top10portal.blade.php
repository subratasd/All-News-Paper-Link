    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header card-header-primary">
                <h4 class="card-title">Top 10 online News Portal</h4>
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($all_portal as  $data)
                            ...
                            <td>
                                ...
                                <a href="top10portal/{{$data->id}}" type="submit" class="btn btn-danger">Delete</a>
