...
@section('title', 'Top 10 English News Portal')
@section('content')
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header card-header-primary">
                <h4 class="card-title">Top 10 English News Portal</h4>
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($all_english as  $data)
                            ...
                            <td>
                                ...
                                <a href="top10english/{{$data->id}}" type="submit" class="btn btn-danger">Delete</a>
