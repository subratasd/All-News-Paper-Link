    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header card-header-primary">
                <h4 class="card-title">Top 10 Online TV</h4>
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card card-plain">
            <div class="card-header card-header-primary">
                <h4 class="card-title mt-0"> TV Channel List</h4>
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($all_tv as  $data)
                            ...
                            <td>
                                ...
                                <a href="top10tv/{{$data->id}}" type="submit" class="btn btn-danger">Delete</a>
